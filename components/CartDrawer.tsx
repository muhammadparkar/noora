  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm animate-fade-in">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col z-10 animate-slide-up sm:animate-none">
        ...
        {/* Cart Header */}
        <div className="p-4 sm:p-6 bg-[#0A0D1A] text-white flex items-center justify-between border-b border-[#1E2540]">
          <div className="flex items-center gap-2">
            <ShoppingBag className="w-5 h-5 text-[#C5A059]" />
            <h2 className="text-lg font-bold tracking-tight">Your Pickup Cart</h2>
            <span className="bg-[#1C233D] text-[#C5A059] text-xs font-bold px-2 py-0.5 rounded-full font-mono">
        ...
        <div className="bg-[#F2ECE1] p-3 px-4 border-b border-[#E0D8C8] flex items-center justify-between text-xs text-[#0A0D1A]">
          ...
          <button
            ...
            className="text-[11px] font-bold text-[#0A0D1A] hover:underline underline-offset-2 shrink-0"
          >
            Change
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
          {cart.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6 text-slate-400 space-y-3">
              ...
              <button
                onClick={() => setIsCartOpen(false)}
                className="mt-2 bg-[#0A0D1A] text-white text-xs px-5 py-2.5 rounded-full font-semibold"
              >
                Browse Menu
              </button>
            </div>
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex items-start justify-between gap-1">
                        <h4 className="font-bold text-[#0A0D1A] text-sm leading-snug">
                          {cartItem.item.title}
                        </h4>
                        <button
                    ...
                    <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-200/60">
                      ...
                      <span className="font-extrabold text-[#0A0D1A] font-mono text-sm">
        ...
        {cart.length > 0 && (
          <div className="p-4 sm:p-6 bg-white border-t border-slate-200 space-y-4 shrink-0 shadow-lg">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between text-base font-extrabold text-[#0A0D1A] pt-2 border-t border-slate-100">
            ...
            <button
              ...
              className="w-full flex items-center justify-between bg-[#0A0D1A] hover:bg-[#161B33] text-white font-semibold text-sm py-3.5 px-5 rounded-full shadow-lg transition active:scale-95 group"
            >
